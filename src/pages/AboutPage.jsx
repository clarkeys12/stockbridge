    ...
    <div className="content-page">
      ...
      <section className="content-page__section">
        <p className="content-page__text">
          <strong>Stockbridge sits where natural materials meet structured form, where the quiet of the outdoors finds its place in the city.</strong>
        </p>
        <p className="content-page__text">
        ...
        <p className="content-page__text">
          <strong>Finding nature in the city.</strong>
        </p>
      </section>
